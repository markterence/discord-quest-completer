...
const { isAccountModalOpen, token, activeUnfinishedQuests, openLoginWindow, userProfile, avatarUrl } = useUserQuests();
          ...
          <ul class="flex items-center space-x-5">
            ...
            <li>
              ...
              >
                ...
                <span>{{ token ? (userProfile?.global_name || userProfile?.username || 'Discord Account') : 'Login with Discord' }}</span>
