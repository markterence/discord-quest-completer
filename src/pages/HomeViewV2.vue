...
import { onClickOutside, refDebounced, tryOnMounted, watchOnce, watchWithFilter } from '@vueuse/core';
...
watchOnce(allFetchDone, (newVal) => {
    if (newVal === true) {
        const gameToAdd = gameDB.value.find(game => game.id === '1328876348361412619');
...
<template>
    <div class="container mx-auto px-4 py-8">
        ...
        <Dialog /> 
        <!-- RPC dialog -->
        <TestRPCDialog ref="dialogRef" @continueRPCRisk="continueRPCRisk(selectedGame)" />
